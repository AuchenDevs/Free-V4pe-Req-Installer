...
python --version | >nul findstr "3.9.*" && (echo   [*] Using python 3.9 good >>"%temp%\VapeInstall.log") || (echo   [!] You need to install python 3.9! ^(I recomend 3.9.11^)>>"%temp%\VapeInstall.log" & "fenderror=Install python 3.9" & goto fend)
...
:fend
echo   - The installantion cannot be completed because %fenderror% >>"%temp%\VapeInstall.log"
"%temp%\VapeInstall.log"